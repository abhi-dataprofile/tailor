-- ============================================================================
-- setup_fresh.sql — everything a NEW Supabase project needs, in one paste.
--
-- Use this when you're starting a clean project (or rebuilding a broken one):
--   Supabase dashboard → SQL Editor → New query → paste this whole file → Run.
--
-- It is the base schema plus every migration applied in order, and it is
-- idempotent (safe to run more than once). After it succeeds, put the new
-- project's URL and keys in .env and start the app — the crawler refills the
-- jobs table on its own.
-- ============================================================================
...
-- ─── migration: application lifecycle (2026-08-08) ──────────────────────
-- ============================================================
...
-- ─── migration: apply queue claim lock (2026-08-08) ─────────────────────
-- ============================================================
...
-- ─── migration: more ATS sources (2026-08-09) ───────────────────────────
-- ============================================================
